...
Note: If you are experiencing high memory consumption (see [issue #467][]) you may consider `--max-retry-sleep=0`.

[issue #467]: https://github.com/GoogleCloudPlatform/gcsfuse/issues/467

...
func NewMonitoringBucket(b gcs2.Bucket) gcs2.Bucket {
...
func (mb *monitoringBucket) CreateObject(
	ctx context.Context,
	req *gcs2.CreateObjectRequest) (*gcs2.Object, error) {
	startTime := time.Now()
...
func (mb *monitoringBucket) CopyObject(
	ctx context.Context,
	req *gcs2.CopyObjectRequest) (*gcs2.Object, error) {
	startTime := time.Now()
...
func (mb *monitoringBucket) ComposeObjects(
	ctx context.Context,
	req *gcs2.ComposeObjectsRequest) (*gcs2.Object, error) {
	startTime := time.Now()
...
func (mb *monitoringBucket) StatObject(
	ctx context.Context,
	req *gcs2.StatObjectRequest) (*gcs2.Object, error) {
	startTime := time.Now()
...
func (mb *monitoringBucket) ListObjects(
	ctx context.Context,
	req *gcs2.ListObjectsRequest) (*gcs2.Listing, error) {
	startTime := time.Now()
...
func (mb *monitoringBucket) UpdateObject(
	ctx context.Context,
	req *gcs2.UpdateObjectRequest) (*gcs2.Object, error) {
	startTime := time.Now()
...
func (mb *monitoringBucket) DeleteObject(
	ctx context.Context,
	req *gcs2.DeleteObjectRequest) error {
	startTime := time.Now()

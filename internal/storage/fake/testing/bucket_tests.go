...
//"/":        "", //unsupported
//}
//for object, content := range objectNames {
//createReq := &gcs.CreateObjectRequest{
//Name:     object,
...
//}
//
//expectedObjecs := []string{"foo/1", "a/2", "4"}
//
//// The object should have been updated.
//
//for _, object := range expectedObjecs {
//m, _, err := t.bucket.StatObject(
//t.ctx,
//&gcs.StatObjectRequest{Name: object,
//ForceFetchFromGcs:              false,
//ReturnExtendedObjectAttributes: false})
//
//AssertEq(nil, err)
//AssertNe(nil, m)
//AssertEq(object, m.Name)
//}
//
//expectedObjecs = []string{"foo"}
//
//// The object should have been updated.
//
//for _, object := range expectedObjecs {
...
//t.ctx,
//&gcs.ListObjectsRequest{Prefix: object, MaxResults: 1})
//
//AssertEq(nil, err)
//AssertNe(nil, listing)
//}

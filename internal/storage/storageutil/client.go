...
func CreateHttpClient(storageClientConfig *StorageClientConfig) (httpClient *http.Client, universeDomain string, err error) {
	...
	if storageClientConfig.AnonymousAccess {
		...
		tokenSrc, universeDomain, err = CreateTokenSource(storageClientConfig)
		if err != nil {
	...
	return httpClient, universeDomain, err
}

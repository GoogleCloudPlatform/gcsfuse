...
func (t *BucketHandleTest) readObjectContent(ctx context.Context, req *request.ReadObjectRequest) (buffer string) {
	rc, err := t.bucketHandle.NewReader(ctx, &request.ReadObjectRequest{
		Name:  req.Name,
		Range: req.Range})

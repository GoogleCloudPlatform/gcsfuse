...
func (m *MockFileCacheHandler) GetCacheHandle(object *gcs.MinObject, bucket gcs.Bucket, cacheForRangeRead bool, initialOffset int64) (*CacheHandle, error) {
	args := m.Called(object, bucket, cacheForRangeRead, initialOffset)
	if ch, ok := args.Get(0).(*CacheHandle); ok {

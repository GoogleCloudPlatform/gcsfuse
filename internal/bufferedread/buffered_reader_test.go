...
func (t *BufferedReaderTest) TestScheduleNextBlock() {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func() {
			...
			err = reader.scheduleNextBlock(context.Background(), tc.urgent)
...
func (t *BufferedReaderTest) TestScheduleNextBlockSuccessive() {
	...
	err = reader.scheduleNextBlock(context.Background(), false)
	require.NoError(t.T(), err)
...
func (t *BufferedReaderTest) TestScheduleBlockWithIndex() {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func() {
			...
			err = reader.scheduleBlockWithIndex(context.Background(), b, tc.blockIndex, tc.urgent)
...
func (t *BufferedReaderTest) TestFreshStart() {
	...
	err = reader.freshStart(context.Background(), currentOffset)
...
func (t *BufferedReaderTest) TestFreshStartWhenInitialCountGreaterThanMax() {
	...
	err = reader.freshStart(context.Background(), 0)
...
func (t *BufferedReaderTest) TestPrefetch() {
	...
	err = reader.prefetch(context.Background())

...
func (t *BufferedReaderTest) TestNewBufferedReader() {
	reader, err := newBufferedReaderWithMinBlockPredictor(t.object, t.bucket, t.config, &staticMinBlockPredictor{minBlockCount: 2}, t.globalMaxBlocksSem, t.workerPool, t.metricHandle)

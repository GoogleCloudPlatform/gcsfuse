...
func (d *Dirent) GetOffset() fuseops.DirOffset       { return d.Offset }
...
func (dp *DirentPlus) GetOffset() fuseops.DirOffset       { return dp.Dirent.Offset }
...
func sortAndResolveEntries[Entry any, WrappedEntry DirEntry](entries []Entry, localEntries map[string]Entry, wrap func(Entry) WrappedEntry, unwrap func(WrappedEntry) Entry) ([]Entry, error) {
	...
	for i, resolvedEntry := range fixedEntries {
		resolvedEntry.SetOffset(fuseops.DirOffset(i) + 1)
	}

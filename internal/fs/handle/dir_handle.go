...
// readAllDirEntryCores retrieves all directory entry cores for the given inode,
...
// FetchDirCores retrieves the core inode data for all entries within the directory from GCS.
//

...
func (fs *fileSystem) CreateFile(
	...
	fs.handles[handleID] = handle.NewFileHandle(child.(*inode.FileInode), fs.fileCacheHandler, fs.cacheFileForRangeRead, fs.metricHandle, fileModeUtil.Write)
	op.Handle = handleID
...
func (fs *fileSystem) OpenFile(
	...
	fs.handles[handleID] = handle.NewFileHandle(in, fs.fileCacheHandler, fs.cacheFileForRangeRead, fs.metricHandle, openMode)
	op.Handle = handleID

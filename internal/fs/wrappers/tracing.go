...
type tracedFuseFileSystem struct {
...
func WithTracing(wrapped fuseutil.FileSystem, traceHandle tracing.TraceHandle) fuseutil.FileSystem {
	return &tracedFuseFileSystem{
		wrapped:     wrapped,
		traceHandle: traceHandle,
	}
}

func (fs *tracedFuseFileSystem) Destroy() {
	fs.wrapped.Destroy()
}

func (fs *tracedFuseFileSystem) invokeWrapped(ctx context.Context, opName string, w wrappedCall) error {
...
func (fs *tracedFuseFileSystem) StatFS(ctx context.Context, op *fuseops.StatFSOp) error {
	return fs.invokeWrapped(ctx, tracing.StatFS, func(ctx context.Context) error { return fs.wrapped.StatFS(ctx, op) })
}

func (fs *tracedFuseFileSystem) LookUpInode(ctx context.Context, op *fuseops.LookUpInodeOp) error {
	return fs.invokeWrapped(ctx, tracing.LookUpInode, func(ctx context.Context) error { return fs.wrapped.LookUpInode(ctx, op) })
}

func (fs *tracedFuseFileSystem) GetInodeAttributes(ctx context.Context, op *fuseops.GetInodeAttributesOp) error {
...
func (fs *tracedFuseFileSystem) SetInodeAttributes(ctx context.Context, op *fuseops.SetInodeAttributesOp) error {

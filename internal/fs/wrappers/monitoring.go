...
var (
	opCount      = stats.Int64("fs/opCount", "The number of ops processed by the file system.", stats.UnitDimensionless)
	opLatency    = stats.Float64("fs/opLatency", "The latency of a file system operation.", stats.UnitMilliseconds)
	opErrorCount = stats.Int64("fs/opErrorCount", "The number of errors generated by file system operation.", stats.UnitDimensionless)
)

...
var (
	...
	requestLatency    = stats.Float64("fs/request_latency", "The latency of a file system request.", stats.UnitMilliseconds)
	requestErrorCount = stats.Int64("fs/request_error_count", "The number of errors generated by file system requests.", stats.UnitDimensionless)
)
...
func init() {
	...
	if err := view.Register(
		...
		&view.View{
			Name:        "fs/request_error_count",
			Measure:     requestErrorCount,
			Description: "The cumulative number of errors generated by file system requests",
			Aggregation: view.Sum(),
			TagKeys:     []tag.Key{tags.FSError},
		},
		&view.View{
			Name:        "fs/request_latency",
			Measure:     requestLatency,
			Description: "The cumulative distribution of file system request latencies",
			Aggregation: ochttp.DefaultLatencyDistribution,
			TagKeys:     []tag.Key{tags.FSLatency},
		}); err != nil {
...
// recordRequest records a file system request latency and error request count
func recordRequest(ctx context.Context, method string, start time.Time, readErr error) {

	// record file system error request count
	if readErr != nil {
		if err := stats.RecordWithTags(
			ctx,
			[]tag.Mutator{
				tag.Upsert(tags.FSError, method),
			},
			requestErrorCount.M(1),
		); err != nil {
			// error in recording the file system error request count
			errorLogger.Printf("Cannot record file system error request count: %v", err)
		}
	}

	// record file system request latency
	readLatency := float64(time.Since(start).Microseconds()) / 1000.0
	if err := stats.RecordWithTags(
		ctx,
		[]tag.Mutator{
			tag.Upsert(tags.FSLatency, method),
		},
		requestLatency.M(readLatency),
	); err != nil {
		// error in recording the file system request latency
		errorLogger.Printf("Cannot record file System request latency: %v", err)
	}
}
...
func (fs *monitoring) StatFS(
	...
	recordRequest(ctx, "StatFS", startTime, err)
	return err
}
...
func (fs *monitoring) LookUpInode(
	...
	recordRequest(ctx, "LookUpInode", startTime, err)
	return err
}
...
func (fs *monitoring) GetInodeAttributes(
	...
	recordRequest(ctx, "GetInodeAttributes", startTime, err)
	return err
}
...
func (fs *monitoring) SetInodeAttributes(
	...
	recordRequest(ctx, "SetInodeAttributes", startTime, err)
...
func (fs *monitoring) ForgetInode(
	...
	recordRequest(ctx, "ForgetInode", startTime, err)
...
func (fs *monitoring) MkDir(
	...
	recordRequest(ctx, "MkDir", startTime, err)
...
func (fs *monitoring) MkNode(
	...
	recordRequest(ctx, "MkNode", startTime, err)
	return err
}
...
func (fs *monitoring) CreateFile(
	...
	recordRequest(ctx, "CreateFile", startTime, err)
	return err
}
...
func (fs *monitoring) CreateLink(
	...
	recordRequest(ctx, "CreateLink", startTime, err)
	return err
}
...
func (fs *monitoring) CreateSymlink(
	...
	recordRequest(ctx, "CreateSymlink", startTime, err)
	return err
}
...
func (fs *monitoring) Rename(
	...
	recordRequest(ctx, "Rename", startTime, err)
	return err
}
...
func (fs *monitoring) RmDir(
	...
	recordRequest(ctx, "RmDir", startTime, err)
	return err
}
...
func (fs *monitoring) Unlink(
	...
	recordRequest(ctx, "Unlink", startTime, err)
	return err
}
...
func (fs *monitoring) OpenDir(
	...
	recordRequest(ctx, "OpenDir", startTime, err)
	return err
}
...
func (fs *monitoring) ReadDir(
	...
	recordRequest(ctx, "ReadDir", startTime, err)
	return err
}
...
func (fs *monitoring) ReleaseDirHandle(
	...
	recordRequest(ctx, "ReleaseDirHandle", startTime, err)
	return err
}
...
func (fs *monitoring) OpenFile(
	...
	recordRequest(ctx, "OpenFile", startTime, err)
	return err
}
...
func (fs *monitoring) ReadFile(
	...
	recordRequest(ctx, "ReadFile", startTime, err)
	return err
}
...
func (fs *monitoring) WriteFile(
	...
	recordRequest(ctx, "WriteFile", startTime, err)
	return err
}
...
func (fs *monitoring) SyncFile(
	...
	recordRequest(ctx, "SyncFile", startTime, err)
	return err
}
...
func (fs *monitoring) FlushFile(
	...
	recordRequest(ctx, "FlushFile", startTime, err)
	return err
}
...
func (fs *monitoring) ReleaseFileHandle(
	...
	recordRequest(ctx, "ReleaseFileHandle", startTime, err)
	return err
}
...
func (fs *monitoring) ReadSymlink(
	...
	recordRequest(ctx, "ReadSymlink", startTime, err)
	return err
}
...
func (fs *monitoring) RemoveXattr(
	...
	recordRequest(ctx, "RemoveXattr", startTime, err)
	return err
}
...
func (fs *monitoring) GetXattr(
	...
	recordRequest(ctx, "GetXattr", startTime, err)
	return err
}
...
func (fs *monitoring) ListXattr(
	...
	recordRequest(ctx, "ListXattr", startTime, err)
	return err
}
...
func (fs *monitoring) SetXattr(
	...
	recordRequest(ctx, "SetXattr", startTime, err)
	return err
}
...
func (fs *monitoring) Fallocate(
	...
	recordRequest(ctx, "Fallocate", startTime, err)
	return err
}

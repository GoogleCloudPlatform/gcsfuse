...
func (t *NonHNSDirTest) TestDeleteObjects() {
	// Arrange
	objectNames := []string{"dir1/file1.txt", "dir2/"}
	t.mockBucket.On("DeleteObject", t.ctx, &gcs.DeleteObjectRequest{Name: "dir1/file1.txt"}).Return(nil)
	// Mock for recursive deletion of dir2/
	...
	listRespSubdir := &gcs.Listing{}
	t.mockBucket.On("ListObjects", t.ctx, listReqSubdir).Return(listRespSubdir, nil)
	t.mockBucket.On("DeleteObject", t.ctx, &gcs.DeleteObjectRequest{Name: "dir2/subdir/"}).Return(nil)
	t.mockBucket.On("DeleteObject", t.ctx, &gcs.DeleteObjectRequest{Name: "dir2/"}).Return(nil)
...
func (t *NonHNSDirTest) TestDeleteObjects_SingleFile() {
	// Arrange
	objectNames := []string{"file1.txt"}
	t.mockBucket.On("DeleteObject", t.ctx, &gcs.DeleteObjectRequest{Name: "file1.txt"}).Return(nil)
...
func (t *NonHNSDirTest) TestDeleteObjects_EmptyPrefix() {
	// Arrange
	objectNames := []string{"emptydir/"}
	listReq := &gcs.ListObjectsRequest{Prefix: "emptydir/", MaxResults: MaxResultsForListObjectsCall, Delimiter: "/"}
	listResp := &gcs.Listing{}
	t.mockBucket.On("ListObjects", t.ctx, listReq).Return(listResp, nil)
	t.mockBucket.On("DeleteObject", t.ctx, &gcs.DeleteObjectRequest{Name: "emptydir/"}).Return(nil)

...
// TODO ezl: temp files created by tests are spilling into tmp folder on disk
// cleanup required or special test method for cache required
...
func interestingLegalNames() (names []string) {
	names = []string{
		...
		// Longest legal name
		// TODO ezl: figure out cache file naming scheme
		// since we store file on cache disk using the same name
		// name + some random number generated by createTemp causing
		// it to be longer than 255 bytes, max size of file name
...
// var _ SetUpInterface = &OpenTest{}
// var _ TearDownInterface = &OpenTest{}

// func (t *OpenTest) TearDown() {
// 	fmt.Printf("TEST RAN CLEANUP TIME")
// 	if t.f1 != nil {
// 		os.Remove(t.f1.Name())
// 	}
// 	if t.f2 != nil {

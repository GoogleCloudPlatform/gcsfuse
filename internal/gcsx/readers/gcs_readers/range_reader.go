...
func (rr *RangeReader) DiscardReader(offset int64, p []byte) {
...
func (rr *RangeReader) GetSeeks() uint64 {
	return rr.seeks
}

func (rr *RangeReader) GetTotalBytes() uint64 {
	return rr.totalReadBytes
}

func (rr *RangeReader) SetEnd(end int64) {
	rr.end = end
}

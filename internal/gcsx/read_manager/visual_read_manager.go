...
func (vrm *VisualReadManager) ReadAt(ctx context.Context, p []byte, offset int64, skipSizeChecks bool) (gcsx.ReadResponse, error) {
	...
	return vrm.wrapped.ReadAt(ctx, p, offset, skipSizeChecks)
}

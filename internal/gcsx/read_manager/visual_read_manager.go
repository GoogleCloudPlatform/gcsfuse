...
func (vrm *VisualReadManager) ReadAt(ctx context.Context, req *gcsx.ReadRequest, skipSizeChecks bool) (gcsx.ReadResponse, error) {
	...
	return vrm.wrapped.ReadAt(ctx, req, skipSizeChecks)
}

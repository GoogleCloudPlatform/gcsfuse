...
func NewMultiRangeDownloaderWrapper(bucket gcs.Bucket, object *gcs.MinObject, perInode bool) MultiRangeDownloaderWrapper {
	return NewMultiRangeDownloaderWrapperWithClock(bucket, object, clock.RealClock{}, perInode)
}

func NewMultiRangeDownloaderWrapperWithClock(bucket gcs.Bucket, object *gcs.MinObject, clock clock.Clock, perInode bool) MultiRangeDownloaderWrapper {
...
type MultiRangeDownloaderWrapper struct {
	...
	clock clock.Clock
	// Flag to determine if the wrapper is per inode or per file handle
	perInode bool
}
...
func (mrdWrapper *MultiRangeDownloaderWrapper) IncrementRefCount() {
	...
	mrdWrapper.refCount++
	if mrdWrapper.perInode && mrdWrapper.cancelCleanup != nil {

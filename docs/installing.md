...
Download and install the latest release package:
    ...
    curl -L -O https://github.com/GoogleCloudPlatform/gcsfuse/releases/download/v0.16.0/gcsfuse-0.16.0-1.x86_64.rpm
    sudo rpm --install -p gcsfuse-0.16.0-1.x86_64.rpm
...
Or one that uses `.deb` files:
    ...
    curl -L -O https://github.com/GoogleCloudPlatform/gcsfuse/releases/download/v0.16.0/gcsfuse_0.16.0_amd64.deb
    sudo dpkg --install gcsfuse_0.16.0_amd64.deb

...
Download and install the latest release package:
    ...
    curl -L -O https://github.com/GoogleCloudPlatform/gcsfuse/releases/download/v0.15.0/gcsfuse-0.15.0-1.x86_64.rpm
    sudo rpm --install -p gcsfuse-0.15.0-1.x86_64.rpm

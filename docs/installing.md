...
Download and install the latest release package:
    ...
    curl -L -O https://github.com/GoogleCloudPlatform/gcsfuse/releases/download/v0.41.7/gcsfuse-0.41.7-1.x86_64.rpm
    sudo rpm --install -p gcsfuse-0.41.7-1.x86_64.rpm
...
If you are on a distribution that uses `.rpm` files for package management:
    ...
    curl -L -O https://github.com/GoogleCloudPlatform/gcsfuse/releases#:~:text=gcsfuse%2D0.41.7%2D1.x86_64.rpm
    sudo rpm --install -p gcsfuse-0.41.7-1.x86_64.rpm

...
'/' as prefix in name or just empty name are not supported in GCSfuse, as the Linux
filesystem does not support files or directories with such name. These objects are
ignored by GCSFuse during any file operations. RmDir operations on parents of

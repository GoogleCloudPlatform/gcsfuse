...
Review the read-locking optimizations and concurrency defect fixes (mainly in `internal/fs/fs.go` and `internal/fs/inode/lookup_count.go`).
Specifically:
...
Write a review report with your verdict (PASS/FAIL) to `/usr/local/google/home/kislayk/gitproj/gcsfuse/.agents/reviewer_m3_4/handoff.md`. Notify the orchestrator (conversation ID: 16ecf609-e12c-496f-a57e-823517e4cde8) when done.

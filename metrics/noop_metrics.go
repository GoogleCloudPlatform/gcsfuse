...
func (*noopMetrics) BufferedReadDownloadBlockLatency(ctx context.Context, duration time.Duration, status Status) {
}
...
func (*noopMetrics) FsOpsLatency(ctx context.Context, duration time.Duration, fsOp FsOp) {}
...
func (*noopMetrics) GcsRequestLatencies(ctx context.Context, duration time.Duration, gcsMethod GcsMethod) {
}

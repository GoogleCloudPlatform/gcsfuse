...
var (
	...
	bufferedReadFallbackTriggerCountFallbackReasonInsufficientMemoryAttrSet = metric.WithAttributeSet(attribute.NewSet(attribute.String("fallback_reason", "insufficient_memory"),))
	bufferedReadFallbackTriggerCountFallbackReasonRandomReadDetectedAttrSet = metric.WithAttributeSet(attribute.NewSet(attribute.String("fallback_reason", "random_read_detected"),))
	...
	gcsReadBytesCountReaderDefaultAttrSet = metric.WithAttributeSet(attribute.NewSet(attribute.String("reader", "Default"),))
...
type otelMetrics struct {
	...
	wg *sync.WaitGroup
	bufferedReadFallbackTriggerCountFallbackReasonInsufficientMemoryAtomic *atomic.Int64
	bufferedReadFallbackTriggerCountFallbackReasonRandomReadDetectedAtomic *atomic.Int64
	...
	gcsReadBytesCountReaderDefaultAtomic *atomic.Int64
...
func (o *otelMetrics) BufferedReadFallbackTriggerCount(
		inc int64, fallbackReason string) {
	if inc < 0 {
		...
		o.bufferedReadFallbackTriggerCountFallbackReasonInsufficientMemoryAtomic.Add(inc)
		case "random_read_detected":
		o.bufferedReadFallbackTriggerCountFallbackReasonRandomReadDetectedAtomic.Add(inc)
		default:
			updateUnrecognizedAttribute(fallbackReason)
			return
	}
}
...
func (o *otelMetrics) GcsReadBytesCount(
	...
	if inc < 0 {
		...
		case "Default":
		o.gcsReadBytesCountReaderDefaultAtomic.Add(inc)
		default:
...
func NewOTelMetrics(ctx context.Context, workers int, bufferSize int) (*otelMetrics, error) {
  ...
  meter := otel.Meter("gcsfuse")
	var bufferedReadFallbackTriggerCountFallbackReasonInsufficientMemoryAtomic,
	bufferedReadFallbackTriggerCountFallbackReasonRandomReadDetectedAtomic atomic.Int64
	...
	_, err0 := meter.Int64ObservableCounter("buffered_read/fallback_trigger_count",
		...
		metric.WithInt64Callback(func(_ context.Context, obsrv metric.Int64Observer) error {
			conditionallyObserve(obsrv, &bufferedReadFallbackTriggerCountFallbackReasonInsufficientMemoryAtomic, bufferedReadFallbackTriggerCountFallbackReasonInsufficientMemoryAttrSet)
			conditionallyObserve(obsrv, &bufferedReadFallbackTriggerCountFallbackReasonRandomReadDetectedAtomic, bufferedReadFallbackTriggerCountFallbackReasonRandomReadDetectedAttrSet)
			return nil
		}))
	...
	_, err9 := meter.Int64ObservableCounter("gcs/read_bytes_count",
		...
		metric.WithInt64Callback(func(_ context.Context, obsrv metric.Int64Observer) error {
			...
			conditionallyObserve(obsrv, &gcsReadBytesCountReaderDefaultAtomic, gcsReadBytesCountReaderDefaultAttrSet)
			return nil
		}))
	...
	return &otelMetrics{
		ch : ch,
		wg: &wg,
			bufferedReadFallbackTriggerCountFallbackReasonInsufficientMemoryAtomic: &bufferedReadFallbackTriggerCountFallbackReasonInsufficientMemoryAtomic,
			bufferedReadFallbackTriggerCountFallbackReasonRandomReadDetectedAtomic: &bufferedReadFallbackTriggerCountFallbackReasonRandomReadDetectedAtomic,
			...
			gcsReadBytesCountReaderDefaultAtomic: &gcsReadBytesCountReaderDefaultAtomic,

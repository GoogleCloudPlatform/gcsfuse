...
var (
	...
	metadataCacheReadCountCacheHitTrueEntryStatusLookupDetailFoundAttrSet                                  = metric.WithAttributeSet(attribute.NewSet(attribute.Bool("cache_hit", true), attribute.String("entry_status", ""), attribute.String("lookup_detail", "found")))
	metadataCacheReadCountCacheHitTrueEntryStatusLookupDetailNotFoundAttrSet                               = metric.WithAttributeSet(attribute.NewSet(attribute.Bool("cache_hit", true), attribute.String("entry_status", ""), attribute.String("lookup_detail", "not_found")))
	metadataCacheReadCountCacheHitTrueEntryStatusLookupDetailTtlExpiredAttrSet                             = metric.WithAttributeSet(attribute.NewSet(attribute.Bool("cache_hit", true), attribute.String("entry_status", ""), attribute.String("lookup_detail", "ttl_expired")))
	...
	metadataCacheReadCountCacheHitFalseEntryStatusLookupDetailFoundAttrSet                                 = metric.WithAttributeSet(attribute.NewSet(attribute.Bool("cache_hit", false), attribute.String("entry_status", ""), attribute.String("lookup_detail", "found")))
	metadataCacheReadCountCacheHitFalseEntryStatusLookupDetailNotFoundAttrSet                              = metric.WithAttributeSet(attribute.NewSet(attribute.Bool("cache_hit", false), attribute.String("entry_status", ""), attribute.String("lookup_detail", "not_found")))
	metadataCacheReadCountCacheHitFalseEntryStatusLookupDetailTtlExpiredAttrSet                            = metric.WithAttributeSet(attribute.NewSet(attribute.Bool("cache_hit", false), attribute.String("entry_status", ""), attribute.String("lookup_detail", "ttl_expired")))

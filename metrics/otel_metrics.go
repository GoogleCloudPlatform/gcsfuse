...
type otelMetrics struct {
	...
	gcsDnsCountAtomic                                                                  *atomic.Int64
...
func (o *otelMetrics) GcsDnsCount(
	inc int64) {
	o.gcsDnsCountAtomic.Add(inc)
...
func NewOTelMetrics(ctx context.Context, workers int, bufferSize int) (*otelMetrics, error) {
	...
	var gcsDnsCountAtomic atomic.Int64
	...
	_, err10 := meter.Int64ObservableCounter("gcs/dns_count",
		metric.WithDescription("The cumulative number of dns requests for GCS."),
		metric.WithUnit(""),
		metric.WithInt64Callback(func(_ context.Context, obsrv metric.Int64Observer) error {
			conditionallyObserve(obsrv, &gcsDnsCountAtomic)
			return nil
		}))
	...
	return &otelMetrics{
		...
		gcsDnsCountAtomic: &gcsDnsCountAtomic,

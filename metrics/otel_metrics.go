...
var (
	...
	fsStreamingWriteFallbackCountOpenModeReadWriteReasonConcurrentLimitBreachedAttrSet       = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "read_write"), attribute.String("reason", "concurrent_limit_breached")))
	fsStreamingWriteFallbackCountOpenModeReadWriteReasonExistingFileAttrSet                  = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "read_write"), attribute.String("reason", "existing_file")))
	fsStreamingWriteFallbackCountOpenModeReadWriteReasonNotEnabledAttrSet                    = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "read_write"), attribute.String("reason", "not_enabled")))
	fsStreamingWriteFallbackCountOpenModeReadWriteReasonOtherAttrSet                         = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "read_write"), attribute.String("reason", "other")))
	fsStreamingWriteFallbackCountOpenModeReadWriteReasonOutOfOrderAttrSet                    = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "read_write"), attribute.String("reason", "out_of_order")))
	fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonConcurrentLimitBreachedAttrSet = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "read_write_append"), attribute.String("reason", "concurrent_limit_breached")))
	fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonExistingFileAttrSet            = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "read_write_append"), attribute.String("reason", "existing_file")))
	fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonNotEnabledAttrSet              = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "read_write_append"), attribute.String("reason", "not_enabled")))
	fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOtherAttrSet                   = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "read_write_append"), attribute.String("reason", "other")))
	fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOutOfOrderAttrSet              = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "read_write_append"), attribute.String("reason", "out_of_order")))
	fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonConcurrentLimitBreachedAttrSet       = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "write_only"), attribute.String("reason", "concurrent_limit_breached")))
	fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonExistingFileAttrSet                  = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "write_only"), attribute.String("reason", "existing_file")))
	fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonNotEnabledAttrSet                    = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "write_only"), attribute.String("reason", "not_enabled")))
	fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOtherAttrSet                         = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "write_only"), attribute.String("reason", "other")))
	fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOutOfOrderAttrSet                    = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "write_only"), attribute.String("reason", "out_of_order")))
	fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonConcurrentLimitBreachedAttrSet = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "write_only_append"), attribute.String("reason", "concurrent_limit_breached")))
	fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonExistingFileAttrSet            = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "write_only_append"), attribute.String("reason", "existing_file")))
	fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonNotEnabledAttrSet              = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "write_only_append"), attribute.String("reason", "not_enabled")))
	fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOtherAttrSet                   = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "write_only_append"), attribute.String("reason", "other")))
	fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOutOfOrderAttrSet              = metric.WithAttributeSet(attribute.NewSet(attribute.String("open_mode", "write_only_append"), attribute.String("reason", "out_of_order")))
...
type otelMetrics struct {
	...
	fsStreamingWriteFallbackCountOpenModeReadWriteReasonConcurrentLimitBreachedAtomic       *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeReadWriteReasonExistingFileAtomic                  *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeReadWriteReasonNotEnabledAtomic                    *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeReadWriteReasonOtherAtomic                         *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeReadWriteReasonOutOfOrderAtomic                    *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonConcurrentLimitBreachedAtomic *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonExistingFileAtomic            *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonNotEnabledAtomic              *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOtherAtomic                   *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOutOfOrderAtomic              *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonConcurrentLimitBreachedAtomic       *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonExistingFileAtomic                  *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonNotEnabledAtomic                    *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOtherAtomic                         *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOutOfOrderAtomic                    *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonConcurrentLimitBreachedAtomic *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonExistingFileAtomic            *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonNotEnabledAtomic              *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOtherAtomic                   *atomic.Int64
	fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOutOfOrderAtomic              *atomic.Int64
...
func (o *otelMetrics) FsStreamingWriteFallbackCount(
	inc int64, openMode OpenMode, reason Reason) {
	if inc < 0 {
	...
	case OpenModeReadWriteAttr:
		switch reason {
		case ReasonConcurrentLimitBreachedAttr:
			o.fsStreamingWriteFallbackCountOpenModeReadWriteReasonConcurrentLimitBreachedAtomic.Add(inc)
		case ReasonExistingFileAttr:
			o.fsStreamingWriteFallbackCountOpenModeReadWriteReasonExistingFileAtomic.Add(inc)
		case ReasonNotEnabledAttr:
			o.fsStreamingWriteFallbackCountOpenModeReadWriteReasonNotEnabledAtomic.Add(inc)
		case ReasonOtherAttr:
			o.fsStreamingWriteFallbackCountOpenModeReadWriteReasonOtherAtomic.Add(inc)
		case ReasonOutOfOrderAttr:
			o.fsStreamingWriteFallbackCountOpenModeReadWriteReasonOutOfOrderAtomic.Add(inc)
		default:
			updateUnrecognizedAttribute(string(reason))
			return
		}
	case OpenModeReadWriteAppendAttr:
		switch reason {
		case ReasonConcurrentLimitBreachedAttr:
			o.fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonConcurrentLimitBreachedAtomic.Add(inc)
		case ReasonExistingFileAttr:
			o.fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonExistingFileAtomic.Add(inc)
		case ReasonNotEnabledAttr:
			o.fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonNotEnabledAtomic.Add(inc)
		case ReasonOtherAttr:
			o.fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOtherAtomic.Add(inc)
		case ReasonOutOfOrderAttr:
			o.fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOutOfOrderAtomic.Add(inc)
		default:
			updateUnrecognizedAttribute(string(reason))
			return
		}
	case OpenModeWriteOnlyAttr:
		switch reason {
		case ReasonConcurrentLimitBreachedAttr:
			o.fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonConcurrentLimitBreachedAtomic.Add(inc)
		case ReasonExistingFileAttr:
			o.fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonExistingFileAtomic.Add(inc)
		case ReasonNotEnabledAttr:
			o.fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonNotEnabledAtomic.Add(inc)
		case ReasonOtherAttr:
			o.fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOtherAtomic.Add(inc)
		case ReasonOutOfOrderAttr:
			o.fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOutOfOrderAtomic.Add(inc)
		default:
			updateUnrecognizedAttribute(string(reason))
			return
		}
	case OpenModeWriteOnlyAppendAttr:
		switch reason {
		case ReasonConcurrentLimitBreachedAttr:
			o.fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonConcurrentLimitBreachedAtomic.Add(inc)
		case ReasonExistingFileAttr:
			o.fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonExistingFileAtomic.Add(inc)
		case ReasonNotEnabledAttr:
			o.fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonNotEnabledAtomic.Add(inc)
		case ReasonOtherAttr:
			o.fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOtherAtomic.Add(inc)
		case ReasonOutOfOrderAttr:
			o.fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOutOfOrderAtomic.Add(inc)
		default:
			updateUnrecognizedAttribute(string(reason))
			return
		}
...
func NewOTelMetrics(ctx context.Context, workers int, bufferSize int) (*otelMetrics, error) {
	...
	var fsStreamingWriteFallbackCountOpenModeReadWriteReasonConcurrentLimitBreachedAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteReasonExistingFileAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteReasonNotEnabledAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteReasonOtherAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteReasonOutOfOrderAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonConcurrentLimitBreachedAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonExistingFileAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonNotEnabledAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOtherAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOutOfOrderAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonConcurrentLimitBreachedAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonExistingFileAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonNotEnabledAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOtherAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOutOfOrderAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonConcurrentLimitBreachedAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonExistingFileAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonNotEnabledAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOtherAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOutOfOrderAtomic atomic.Int64
	...
	_, err8 := meter.Int64ObservableCounter("fs/streaming_write_fallback_count",
		...
		metric.WithUnit(""),
		metric.WithInt64Callback(func(_ context.Context, obsrv metric.Int64Observer) error {
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeReadWriteReasonConcurrentLimitBreachedAtomic, fsStreamingWriteFallbackCountOpenModeReadWriteReasonConcurrentLimitBreachedAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeReadWriteReasonExistingFileAtomic, fsStreamingWriteFallbackCountOpenModeReadWriteReasonExistingFileAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeReadWriteReasonNotEnabledAtomic, fsStreamingWriteFallbackCountOpenModeReadWriteReasonNotEnabledAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeReadWriteReasonOtherAtomic, fsStreamingWriteFallbackCountOpenModeReadWriteReasonOtherAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeReadWriteReasonOutOfOrderAtomic, fsStreamingWriteFallbackCountOpenModeReadWriteReasonOutOfOrderAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonConcurrentLimitBreachedAtomic, fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonConcurrentLimitBreachedAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonExistingFileAtomic, fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonExistingFileAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonNotEnabledAtomic, fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonNotEnabledAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOtherAtomic, fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOtherAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOutOfOrderAtomic, fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOutOfOrderAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonConcurrentLimitBreachedAtomic, fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonConcurrentLimitBreachedAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonExistingFileAtomic, fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonExistingFileAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonNotEnabledAtomic, fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonNotEnabledAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOtherAtomic, fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOtherAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOutOfOrderAtomic, fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOutOfOrderAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonConcurrentLimitBreachedAtomic, fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonConcurrentLimitBreachedAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonExistingFileAtomic, fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonExistingFileAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonNotEnabledAtomic, fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonNotEnabledAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOtherAtomic, fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOtherAttrSet)
			conditionallyObserve(obsrv, &fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOutOfOrderAtomic, fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOutOfOrderAttrSet)
			return nil
		}))
	...
	return &otelMetrics{
		...
		fsStreamingWriteFallbackCountOpenModeReadWriteReasonConcurrentLimitBreachedAtomic:       &fsStreamingWriteFallbackCountOpenModeReadWriteReasonConcurrentLimitBreachedAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteReasonExistingFileAtomic:                  &fsStreamingWriteFallbackCountOpenModeReadWriteReasonExistingFileAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteReasonNotEnabledAtomic:                    &fsStreamingWriteFallbackCountOpenModeReadWriteReasonNotEnabledAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteReasonOtherAtomic:                         &fsStreamingWriteFallbackCountOpenModeReadWriteReasonOtherAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteReasonOutOfOrderAtomic:                    &fsStreamingWriteFallbackCountOpenModeReadWriteReasonOutOfOrderAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonConcurrentLimitBreachedAtomic: &fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonConcurrentLimitBreachedAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonExistingFileAtomic:            &fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonExistingFileAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonNotEnabledAtomic:              &fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonNotEnabledAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOtherAtomic:                   &fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOtherAtomic,
		fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOutOfOrderAtomic:              &fsStreamingWriteFallbackCountOpenModeReadWriteAppendReasonOutOfOrderAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonConcurrentLimitBreachedAtomic:       &fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonConcurrentLimitBreachedAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonExistingFileAtomic:                  &fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonExistingFileAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonNotEnabledAtomic:                    &fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonNotEnabledAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOtherAtomic:                         &fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOtherAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOutOfOrderAtomic:                    &fsStreamingWriteFallbackCountOpenModeWriteOnlyReasonOutOfOrderAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonConcurrentLimitBreachedAtomic: &fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonConcurrentLimitBreachedAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonExistingFileAtomic:            &fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonExistingFileAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonNotEnabledAtomic:              &fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonNotEnabledAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOtherAtomic:                   &fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOtherAtomic,
		fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOutOfOrderAtomic:              &fsStreamingWriteFallbackCountOpenModeWriteOnlyAppendReasonOutOfOrderAtomic,

...
// OpType is a custom type for the op_type attribute.
type OpType string
const (
	OpTypeReadAttr OpType = "read"
	OpTypeWriteAttr OpType = "write"
)
...
type MetricHandle interface {
	...
	// IoDepthFs - Current number of concurrent I/O operations in the filesystem by operation type.
	IoDepthFs(inc int64, opType OpType)

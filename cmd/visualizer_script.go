...
// handleVisualizerScript contains the python script for visualizing file handle read patterns.
// This is embedded here to allow the GCSFuse binary to distribute the tool without needing
// the source repository structure at runtime.
const handleVisualizerScript = `#!/usr/bin/env python3
import argparse
import json
import re
import sys

...
func forwardedEnvVars() []string {
	...
	// This environment variable will be used to enhance our logging by using unique
	// mount instance Id to identidy different mounts.
...
func Mount(newConfig *cfg.Config, wrapperConfig map[string]interface{}, bucketName, mountPoint string) (err error) {
	...
	logger.SetLogFormatAndFsName(newConfig.Logging.Format, fsName)
	logger.Infof("Creating Logger")

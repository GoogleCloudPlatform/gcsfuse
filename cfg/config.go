...
func BuildFlagSet(flagSet *pflag.FlagSet) error {
  ...
  flagSet.IntP("write-global-max-blocks", "", 3, "Specifies the maximum number of blocks to be used by all files for streaming writes. The value should be >= 1 or -1 (for infinite blocks).")

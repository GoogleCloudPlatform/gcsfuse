...
func BindFlags(v *viper.Viper, flagSet *pflag.FlagSet) error {
	...
	flagSet.IntP("max-retry-attempts", "", 100, "It sets a limit on the number of times an operation will be retried if it fails, preventing endless retry loops. Default value is 6.")

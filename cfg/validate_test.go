...
func Test_isValidWriteStreamingConfig_ErrorScenarios(t *testing.T) {
	var testCases = []struct {
		...
		{"negative_block_size_kb", WriteConfig{
			BlockSizeMb:           32,
			BlockSizeKb:           -1,
			CreateEmptyFile:       false,
			EnableStreamingWrites: true,
		...
		{"very_large_block_size_kb", WriteConfig{
			BlockSizeMb:           32,
			BlockSizeKb:           util.MaxKiBsInInt64 + 1,
			CreateEmptyFile:       false,
			EnableStreamingWrites: true,
			GlobalMaxBlocks:       -1,
			MaxBlocksPerFile:      -1,
...
func Test_isValidWriteStreamingConfig_SuccessScenarios(t *testing.T) {
	var testCases = []struct {
		...
		{"valid_block_size_kb", WriteConfig{
			BlockSizeMb:           32,
			BlockSizeKb:           256,
			CreateEmptyFile:       false,
			EnableStreamingWrites: true,
		...
		{"zero_block_size_kb", WriteConfig{
			BlockSizeMb:           32,
			BlockSizeKb:           0,
			CreateEmptyFile:       false,
			EnableStreamingWrites: true,

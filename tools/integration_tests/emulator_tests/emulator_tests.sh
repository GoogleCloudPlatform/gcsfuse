...
if [ -f /etc/debian_version ]; then
  ...
  sudo apt-get update
  sudo apt-get install -y docker-ce docker-ce-cli containerd.io # TODO(mohitkyadav): These dependencies do not work on Cloudtop docker-buildx-plugin docker-compose-plugin

...
func createMountConfigsAndEquivalentFlags() (flags [][]string) {
	...
	// Set up config file testing metadata-prefetch-on-mount: "asynchronous".
	...
	flags = append(flags, []string{"--config-file=" + filePath4, "--metadata-prefetch-on-mount=asynchronous"})

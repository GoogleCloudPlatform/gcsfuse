...
type CreateThreeLevelDirSuite struct {
	suite.Suite
	runCfg parallel.RunConfiguration
}

func (s *CreateThreeLevelDirSuite) TestCreateThreeLevelDirectories() {
	// Directory structure
...
func TestCreateThreeLevelDir(t *testing.T) {
	s := new(CreateThreeLevelDirSuite)

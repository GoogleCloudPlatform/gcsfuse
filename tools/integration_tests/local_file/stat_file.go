...
func (t *CommonLocalFileTestSuite) TestStatOnLocalFile() {
	// Stat the local file.
	operations.VerifyStatFile(t.filePath, 0, FilePerms, t.T())
	...
	operations.VerifyStatFile(t.filePath, SizeOfFileContents, FilePerms, t.T())
...
func (t *CommonLocalFileTestSuite) TestStatOnLocalFileWithConflictingFileNameSuffix() {
	// Stat the local file.
	operations.VerifyStatFile(t.filePath+inode.ConflictingFileNameSuffix, 0, FilePerms, t.T())
...
func (t *localFileTestSuite) TestTruncateLocalFileToSmallerSize() {
	...
	err := os.Truncate(t.filePath, SmallerSizeTruncate)
	if err != nil {
	...
	operations.VerifyStatFile(t.filePath, SmallerSizeTruncate, FilePerms, t.T())
	// Close the file and validate that the file is created on GCS.
	CloseFileAndValidateContentFromGCS(t.ctx, t.storageClient, t.fh, t.testDirName,

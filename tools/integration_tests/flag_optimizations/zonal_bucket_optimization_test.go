...
func (s *KernelReaderParamsSuite) TestKernelParamVerification() {
	...
	optimizedMaxBackground := fmt.Sprintf("%d", cfg.BucketTypeRapid.DefaultMaxBackground())
	optimizedCongestion := fmt.Sprintf("%d", cfg.BucketTypeRapid.DefaultCongestionThreshold())

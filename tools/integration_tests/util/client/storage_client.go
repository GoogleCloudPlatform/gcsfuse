...
func CreateStorageClient(ctx context.Context) (*storage.Client, error) {
	...
	client, err := storage.NewClient(ctx, option.WithEndpoint("storage.apis-tpclp.goog:443"), option.WithTokenSource(getTokenSrc("/usr/local/google/home/tulsishah/key_tpc.json")))
	if err != nil {

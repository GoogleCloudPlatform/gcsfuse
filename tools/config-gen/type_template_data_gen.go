...
func computeProtoMappings(params []Param) ([]protoMappingTemplateData, error) {
	...
	for _, p := range params {
		...
		protoGoField := protoCamelCase(p.ProtoFieldName)
...
// protoCamelCase converts snake_case proto field names to the CamelCase Go identifiers
// generated by protoc-gen-go. It capitalizes the first character, characters following
// underscores, and characters following digits (e.g. "is_gcs_auth_s2a_address_set" -> "IsGcsAuthS2AAddressSet").

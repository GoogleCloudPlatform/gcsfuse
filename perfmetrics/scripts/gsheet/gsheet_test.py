...
def check_write_to_google_sheet_missing_permissions_raises_http_error_when_KOKORO_JOB_TYPE_env_variable_is_set(self,KOKORO_JOB_TYPE):
  os.environ["KOKORO_JOB_TYPE"] = KOKORO_JOB_TYPE
...
class GsheetTest(unittest.TestCase):
  ...
  def test_write_to_google_sheet_missing_permissions_raises_http_error_when_KOKORO_JOB_TYPE_env_variable_equals_RELEASE(self):
    check_write_to_google_sheet_missing_permissions_raises_http_error_when_KOKORO_JOB_TYPE_env_variable_is_set(self,"RELEASE")
  ...
  def test_write_to_google_sheet_missing_permissions_raises_http_error_when_KOKORO_JOB_TYPE_env_variable_equals_CONTINUOUS_INTEGRATION(self):
    check_write_to_google_sheet_missing_permissions_raises_http_error_when_KOKORO_JOB_TYPE_env_variable_is_set(self,"CONTINUOUS_INTEGRATION")
  ...
  def test_write_to_google_sheet_missing_permissions_raises_http_error_when_KOKORO_JOB_TYPE_env_variable_equals_PRESUBMIT_GITHUB(self):
    check_write_to_google_sheet_missing_permissions_raises_http_error_when_KOKORO_JOB_TYPE_env_variable_is_set(self,"PRESUBMIT_GITHUB")

  def test_write_to_google_sheet_when_KOKORO_JOB_TYPE_env_variable_is_not_set(self):
    print("Tulsi")
    check_write_to_google_sheet_when_KOKORO_JOB_TYPE_env_variable_is_set(self,"")

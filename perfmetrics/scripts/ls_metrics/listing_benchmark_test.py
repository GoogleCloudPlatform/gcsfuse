...
DIRECTORY_STRUCTURE1 = ParseDict(DIRECTORY_STRUCTURE1, directory_proto.Directory())
DIRECTORY_STRUCTURE2 = ParseDict(DIRECTORY_STRUCTURE2, directory_proto.Directory())
DIRECTORY_STRUCTURE3 = ParseDict(DIRECTORY_STRUCTURE3, directory_proto.Directory())

class ListingBenchmarkTest(unittest.TestCase):

  def test_parse_results_type1(self):
    metrics = listing_benchmark._parse_results(DIRECTORY_STRUCTURE1.folders, {}, "fake_test", 5)
  ...
  def test_perform_testing_type1(self, mock_record_time_of_operation):
    ...
    gcs_bucket_results, persistent_disk_results = listing_benchmark._perform_testing(DIRECTORY_STRUCTURE1.folders,
                                                                                     "fake_bucket", "fake_disk", 3, "ls -R")
  ...
  def test_perform_testing_type2(self, mock_record_time_of_operation):
    mock_record_time_of_operation.return_value = [1, 1, 1]
    gcs_bucket_results, persistent_disk_results = listing_benchmark._perform_testing(DIRECTORY_STRUCTURE2.folders,
                                                                                     "fake_bucket", "fake_disk", 3, "ls -R")
    self.assertEqual(gcs_bucket_results, persistent_disk_results)
  ...
  def test_perform_testing_type3(self, mock_record_time_of_operation):
    ...
    gcs_bucket_results, persistent_disk_results = listing_benchmark._perform_testing(DIRECTORY_STRUCTURE3.folders,
                                                                                     "fake_bucket", "fake_disk", 2, "ls -R")
    self.assertEqual(gcs_bucket_results, persistent_disk_results)
    self.assertTrue(mock_record_time_of_operation.called)
    self.assertEqual(gcs_bucket_results, {
  ...
  def test_create_directory_structure_type1(self, mock_generate_files, mock_subprocess_call):
    exit_code = listing_benchmark._create_directory_structure("fake_bucket_url/", "fake_disk_url/",
                                                              DIRECTORY_STRUCTURE1, True)
  ...
  def test_create_directory_structure_type2(self, mock_generate_files, mock_subprocess_call):
    ...
    self.assertEqual(mock_generate_files.call_args_list, [
        ...
        call('fake_bucket_url/2KB_3files_0subdir/', 3, 'kb', 2, 'file', 'fake_disk_url/2KB_3files_0subdir/', True),
        call('fake_bucket_url/1KB_2files_0subdir/', 2, 'kb', 1, 'file', 'fake_disk_url/1KB_2files_0subdir/', True)
    ])
  ...
  def test_create_directory_structure_type3(self, mock_generate_files, mock_subprocess_call):
    ...
    self.assertEqual(mock_generate_files.call_args_list, [
        call('fake_bucket_url/1KB_4files_3subdir/', 4, 'kb', 1, 'file', 'fake_disk_url/1KB_4files_3subdir/', True),
        call('fake_bucket_url/1KB_4files_3subdir/subdir1/', 1, 'kb', 1, 'file', 'fake_disk_url/1KB_4files_3subdir/subdir1/', True),
        call('fake_bucket_url/1KB_4files_3subdir/subdir1/subsubdir1/', 2, 'kb', 1, 'file', 'fake_disk_url/1KB_4files_3subdir/subdir1/subsubdir1/', True),
        call('fake_bucket_url/1KB_4files_3subdir/subdir2/', 1, 'kb', 1, 'file', 'fake_disk_url/1KB_4files_3subdir/subdir2/', True),
        call('fake_bucket_url/1KB_4files_3subdir/subdir3/', 1, 'kb', 1, 'file', 'fake_disk_url/1KB_4files_3subdir/subdir3/', True),
        call('fake_bucket_url/1KB_4files_3subdir/subdir3/subsubdir1/', 1, 'kb', 1, 'file', 'fake_disk_url/1KB_4files_3subdir/subdir3/subsubdir1/', True),
        call('fake_bucket_url/2KB_3files_1subdir/', 3, 'kb', 2, 'file', 'fake_disk_url/2KB_3files_1subdir/', True),
        call('fake_bucket_url/1KB_1files_0subdir/', 1, 'kb', 1, 'file', 'fake_disk_url/1KB_1files_0subdir/', True)
    ])
  ...
  def test_compare_directory_structure_true_type2(self, mock_list):
    mock_list.side_effect = [
        ["fake_bucket/", "fake_bucket/file", "fake_bucket/2KB_3files_0subdir/", "fake_bucket/1KB_2files_0subdir/", "fake_bucket/1KB_0files_0subdir/"],
        ["fake_bucket/2KB_3files_0subdir/file_1", "fake_bucket/2KB_3files_0subdir/file_2", "fake_bucket/2KB_3files_0subdir/file_3"],
        ["fake_bucket/1KB_2files_0subdir/file_1", "fake_bucket/1KB_2files_0subdir/file_2"],
        []
    ]
    result = listing_benchmark._compare_directory_structure("fake_bucket/", DIRECTORY_STRUCTURE2)
    self.assertTrue(result)
  ...
  def test_compare_directory_structure_false_folder_type2(self, mock_list):
    mock_list.side_effect = [
        ["fake_bucket/", "fake_bucket/file", "fake_bucket/2KB_3files_0subdir/", "fake_bucket/1KB_2files_0subdir/", "fake_bucket/1KB_0files_0subdir/"],
        ["fake_bucket/2KB_3files_0subdir/dummy_folder/", "fake_bucket/2KB_3files_0subdir/file_1", "fake_bucket/2KB_3files_0subdir/file_2", "fake_bucket/2KB_3files_0subdir/file_3"],
        ["fake_bucket/1KB_2files_0subdir/file_1", "fake_bucket/1KB_2files_0subdir/file_2"],
        []
    ]
    result = listing_benchmark._compare_directory_structure("fake_bucket/", DIRECTORY_STRUCTURE2)
  ...
  def test_compare_directory_structure_false_file_type2(self, mock_list):
    mock_list.side_effect = [
        ["fake_bucket/", "fake_bucket/2KB_3files_0subdir/", "fake_bucket/1KB_2files_0subdir/", "fake_bucket/1KB_0files_0subdir/"],
        ["fake_bucket/2KB_3files_0subdir/file_1", "fake_bucket/2KB_3files_0subdir/file_2", "fake_bucket/2KB_3files_0subdir/file_3"],
        ["fake_bucket/1KB_2files_0subdir/file_1", "fake_bucket/1KB_2files_0subdir/file_2"],
        []
    ]
  ...
  def test_compare_directory_structure_true_type3(self, mock_list):
    mock_list.side_effect = [
        ["fake_bucket/", "fake_bucket/1KB_4files_3subdir/", "fake_bucket/2KB_3files_1subdir/", "fake_bucket/1KB_1files_0subdir/"],
        ["fake_bucket/1KB_4files_3subdir/file_1", "fake_bucket/1KB_4files_3subdir/file_2", "fake_bucket/1KB_4files_3subdir/file_3", "fake_bucket/1KB_4files_3subdir/file_4",
         "fake_bucket/1KB_4files_3subdir/subdir1/", "fake_bucket/1KB_4files_3subdir/subdir2/", "fake_bucket/1KB_4files_3subdir/subdir3/"],
        ["fake_bucket/1KB_4files_3subdir/subdir1/file_1", "fake_bucket/1KB_4files_3subdir/subdir1/subsubdir1/", "fake_bucket/1KB_4files_3subdir/subdir1/subsubdir2/"],
        ["fake_bucket/1KB_4files_3subdir/subdir1/subsubdir1/file_1", "fake_bucket/1KB_4files_3subdir/subdir1/subsubdir1/file_2"],
        [],
        ["fake_bucket/1KB_4files_3subdir/subdir2/file_1"],
        ["fake_bucket/1KB_4files_3subdir/subdir3/file_1", "fake_bucket/1KB_4files_3subdir/subdir3/subsubdir1/"],
        ["fake_bucket/1KB_4files_3subdir/subdir3/subsubdir1/file_1"],
        ["fake_bucket/2KB_3files_1subdir/file_1", "fake_bucket/2KB_3files_1subdir/file_2", "fake_bucket/2KB_3files_1subdir/file_3", "fake_bucket/2KB_3files_1subdir/subdir1/"],
        [],
        ["fake_bucket/1KB_1files_0subdir/file_1"]
    ]
    result = listing_benchmark._compare_directory_structure("fake_bucket/", DIRECTORY_STRUCTURE3)
    self.assertTrue(result)

  @patch("listing_benchmark._list_directory")
  def test_compare_directory_structure_false_file_folder_type3(self, mock_list):
    mock_list.side_effect = [
        ["fake_bucket/", "fake_bucket/file1", "fake_bucket/1KB_4files_3subdir/", "fake_bucket/2KB_3files_1subdir/", "fake_bucket/1KB_1files_0subdir/"],
        ["fake_bucket/1KB_4files_3subdir/file_1", "fake_bucket/1KB_4files_3subdir/file_2", "fake_bucket/1KB_4files_3subdir/file_3", "fake_bucket/1KB_4files_3subdir/file_4",
         "fake_bucket/1KB_4files_3subdir/subdir1/", "fake_bucket/1KB_4files_3subdir/subdir2/", "fake_bucket/1KB_4files_3subdir/subdir3/"],
        ["fake_bucket/1KB_4files_3subdir/subdir1/file_1", "fake_bucket/1KB_4files_3subdir/subdir1/subsubdir1/", "fake_bucket/1KB_4files_3subdir/subdir1/subsubdir2/"],
        ["fake_bucket/1KB_4files_3subdir/subdir1/subsubdir1/file_1", "fake_bucket/1KB_4files_3subdir/subdir1/subsubdir1/file_2"],
        ...
        ["fake_bucket/1KB_4files_3subdir/subdir3/subsubdir1/file_1"],
        ["fake_bucket/2KB_3files_1subdir/file_1", "fake_bucket/2KB_3files_1subdir/file_2", "fake_bucket/2KB_3files_1subdir/file_3", "fake_bucket/2KB_3files_1subdir/subdir1/"],
        ["fake_bucket/2KB_3files_1subdir/subdir1/file_1", "fake_bucket/2KB_3files_1subdir/subdir1/dummy_folder/"],
        ["fake_bucket/1KB_1files_0subdir/file_1"]
    ]
    result = listing_benchmark._compare_directory_structure("fake_bucket/", DIRECTORY_STRUCTURE3)
    self.assertFalse(result)
  ...
  def test_unmount_gcs_bucket(self, mock_subprocess_call):
    ...
    self.assertEqual(mock_subprocess_call.call_args_list[0], call("umount -l fake_bucket", shell=True))
    self.assertEqual(mock_subprocess_call.call_args_list[1], call("rm -rf fake_bucket", shell=True))
  ...
  def test_unmount_gcs_bucket_error(self, mock_subprocess_call):
    ...
    self.assertEqual(mock_subprocess_call.call_count, 2)
    self.assertEqual(mock_subprocess_call.call_args_list[0], call("umount -l fake_bucket", shell=True))
    self.assertEqual(mock_subprocess_call.call_args_list[1], call("bash", shell=True))

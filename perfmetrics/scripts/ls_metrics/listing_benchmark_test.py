...
class ListingBenchmarkTest(unittest.TestCase):
    ...
    def test_create_directory_structure_type2(self, mock_generate_files, mock_subprocess_call):
        ...
        self.assertEqual(mock_generate_files.call_args_list, [
            call('fake_bucket_url/', 1, 'kb', 1,
                 'file', 'fake_disk_url/', True),
            call('fake_bucket_url/2KB_3files_0subdir/', 3, 'kb', 2,
                 'file', 'fake_disk_url/2KB_3files_0subdir/', True),
            call('fake_bucket_url/1KB_2files_0subdir/', 2, 'kb', 1,
                 'file', 'fake_disk_url/1KB_2files_0subdir/', True)
        ])
    ...
    def test_compare_directory_structure_true_type3(self, mock_list):
        mock_list.side_effect = [
            ...
            ['fake_bucket/1KB_4files_3subdir/subdir1/file_1', 'fake_bucket/1KB_4files_3subdir/subdir1/subsubdir1/',

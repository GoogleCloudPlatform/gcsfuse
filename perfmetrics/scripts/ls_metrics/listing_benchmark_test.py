...
DIRECTORY_STRUCTURE_2_VALUES = [
    ['ls', 3, 5, 0.017, 1.234, 0.518, 0.222, 0.556, 0.1, 0.222, 1.138, 1.186],
    ['ls', 2, 5, 0.001, 90.45, 19.965, 1.95, 39.504, 0.267, 1.95, 57.106, 73.778],
    ['ls', 0, 5, 6.0, 100.0, 37, 21, 39.63, 6.8, 21.0, 80.4, 90.2]
]

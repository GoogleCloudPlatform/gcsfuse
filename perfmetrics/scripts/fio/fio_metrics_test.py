    ...
    calls = [
        ...
        mock.call.spreadsheets().values().update(
            ...
            body={
                'majorDimension':
                    'ROWS',
                'values': [('1_thread', 50000, 40, 'read', 1653027084,
        ...
        mock.call.spreadsheets().values().update(
            ...
            body={
                'majorDimension':
                    'ROWS',
                'values': [
                    ('1_thread', 50000, 40, 'read', 1653381687, 1653381758,
                     ...
                     0.526385152),
                    ('2_thread', 50000, 10, 'write', 1653381758, 1653381828,

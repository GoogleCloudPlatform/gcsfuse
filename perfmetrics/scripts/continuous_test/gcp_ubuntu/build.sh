...
# =================================================================
# 2) DISTRIBUTED WRITE BENCHMARK + REST OF TESTS
# =================================================================
    ...
    # --- Now execute the local performance tests ---
    ...
    UPLOAD_FLAGS=""
    if [ "${KOKORO_JOB_TYPE}" == "RELEASE" ] || [ "${KOKORO_JOB_TYPE}" == "CONTINUOUS_INTEGRATION" ] || [ "${KOKORO_JOB_TYPE}" == "PRESUBMIT_GITHUB" ] || [ "${KOKORO_JOB_TYPE}" == "SUB_JOB" ]; then

...
sudo docker build . -f perfmetrics/scripts/continuous_test/ml_tests/tf/Dockerfile -t dlc-gcsfuse --build-arg DLC_IMAGE_NAME=tf-gpu.2-10
...
chmod +x perfmetrics/scripts/continuous_test/ml_tests/tf/resnet_run.sh
source perfmetrics/scripts/continuous_test/ml_tests/tf/resnet_run.sh

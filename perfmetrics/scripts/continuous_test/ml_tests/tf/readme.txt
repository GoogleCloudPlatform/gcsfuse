This file contains the code flow for tf based kokoro job.
...
setup_container.sh does go installation, then clone and build gcsfuse from log_rotation branch in the repo.
...
resnet_runner.py containes the necessary details for setting up resnet18 model and 
creating a tf.dataset instance and trains the model on the data for epochs specified.

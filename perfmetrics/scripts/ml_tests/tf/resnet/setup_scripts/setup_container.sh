...
nohup gcsfuse/gcsfuse --foreground --implicit-dirs --enable-storage-client-library --debug_fs --debug_gcs --max-conns-per-host 100 --log-format "text" --log-file /home/logs/log.txt --stackdriver-export-interval 60s ml-models-data-gcsfuse myBucket > /home/output/gcsfuse.out 2> /home/output/gcsfuse.err &

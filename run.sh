...
DATA_FILE="/home/princer_google_com/bucket/data.txt"
...
gcsfuse --enable-buffered-read --log-file "$LOG_FILE" --log-severity trace --log-format text "$BUCKET_NAME" "$MOUNT_POINT"

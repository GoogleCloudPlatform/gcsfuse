...
require (
	...
	github.com/jacobsa/fuse v0.0.0-20251121134604-f34e17fec325
...
replace github.com/ncruces/go-dns => github.com/kislaykishore/go-dns v0.0.0-20251213183049-43462375a6c6
